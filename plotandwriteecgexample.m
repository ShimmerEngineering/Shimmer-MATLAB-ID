...
if (HPF)
    ...
    hpfexg2ch1 = com.shimmerresearch.algorithms.Filter(com.shimmerresearch.algorithms.Filter.HIGH_PASS,fs,fchp);
    hpfexg2ch2 = com.shimmerresearch.algorithms.Filter(com.shimmerresearch.algorithms.Filter.HIGH_PASS,fs,fchp);
end
